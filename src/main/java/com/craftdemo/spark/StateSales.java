...
public class StateSales extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** Id of the customer */
  @Deprecated public CharSequence customerid;
   ...
   */
  public StateSales(CharSequence customerid, CharSequence name, CharSequence street, CharSequence city, CharSequence state, CharSequence zip, Float salesprice, Long timestamp) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: customerid = (CharSequence)value$; break;
    case 1: name = (CharSequence)value$; break;
    case 2: street = (CharSequence)value$; break;
    case 3: city = (CharSequence)value$; break;
    case 4: state = (CharSequence)value$; break;
    case 5: zip = (CharSequence)value$; break;
    case 6: salesprice = (Float)value$; break;
   ...
   */
  public static com.craftdemo.spark.StateSales.Builder newBuilder() {
    return new com.craftdemo.spark.StateSales.Builder();
  }
   ...
   * @return A new StateSales RecordBuilder
   */
  public static com.craftdemo.spark.StateSales.Builder newBuilder(com.craftdemo.spark.StateSales.Builder other) {
    return new com.craftdemo.spark.StateSales.Builder(other);
  }
   ...
   * @return A new StateSales RecordBuilder
   */
  public static com.craftdemo.spark.StateSales.Builder newBuilder(com.craftdemo.spark.StateSales other) {
    return new com.craftdemo.spark.StateSales.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StateSales>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.craftdemo.spark.StateSales.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.craftdemo.spark.StateSales other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.customerid)) {
        this.customerid = data().deepCopy(fields()[0].schema(), other.customerid);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.craftdemo.spark.StateSales.Builder setCustomerid(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.craftdemo.spark.StateSales.Builder clearCustomerid() {
      customerid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.craftdemo.spark.StateSales.Builder setName(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.craftdemo.spark.StateSales.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.craftdemo.spark.StateSales.Builder setStreet(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.craftdemo.spark.StateSales.Builder clearStreet() {
      street = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.craftdemo.spark.StateSales.Builder setCity(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.craftdemo.spark.StateSales.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.craftdemo.spark.StateSales.Builder setState(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.craftdemo.spark.StateSales.Builder clearState() {
      state = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.craftdemo.spark.StateSales.Builder setZip(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.craftdemo.spark.StateSales.Builder clearZip() {
      zip = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.craftdemo.spark.StateSales.Builder setSalesprice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.craftdemo.spark.StateSales.Builder clearSalesprice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.craftdemo.spark.StateSales.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.craftdemo.spark.StateSales.Builder clearTimestamp() {
    ...
    public StateSales build() {
      try {
        ...
        record.customerid = fieldSetFlags()[0] ? this.customerid : (CharSequence) defaultValue(fields()[0]);
        record.name = fieldSetFlags()[1] ? this.name : (CharSequence) defaultValue(fields()[1]);
        record.street = fieldSetFlags()[2] ? this.street : (CharSequence) defaultValue(fields()[2]);
        record.city = fieldSetFlags()[3] ? this.city : (CharSequence) defaultValue(fields()[3]);
        record.state = fieldSetFlags()[4] ? this.state : (CharSequence) defaultValue(fields()[4]);
        record.zip = fieldSetFlags()[5] ? this.zip : (CharSequence) defaultValue(fields()[5]);
        record.salesprice = fieldSetFlags()[6] ? this.salesprice : (Float) defaultValue(fields()[6]);
